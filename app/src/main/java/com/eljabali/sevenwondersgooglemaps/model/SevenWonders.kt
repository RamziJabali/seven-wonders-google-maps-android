...
enum class SevenWonders(val location: LatLng, @StringRes val description: Int, val wonderOfTheWorldImageURL: String) {
    PYRAMIDS_OF_GIZA(LatLng(29.979402, 31.134566), R.string.pyramids_of_giza, "https://www.planetware.com/photos-large/EGY/egypt-cairo-pyramids-of-giza-and%20camels-2.jpg"),
    ...
    LIGHTHOUSE_OF_ALEXANDRIA(LatLng(31.214423294920753, 29.891364913457224), R.string.lighthouse_of_alexandria, "https://www.konnecthq.com/wp-content/uploads/2019/07/Lighthouse-of-Alexandria-31-12-1.jpg");
}
